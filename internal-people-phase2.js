(() => {
  ...
  function installWorkspaceMarkup() {
    ...
    if (documents) documents.innerHTML = `
      ...
      <div class="people-privacy-note"><div><b>Private by design</b>Documents stay inside the existing non-public Supabase bucket. Employee and HR-only visibility rules remain unchanged.</div></div>
  ...
  function renderPeople(data) {
    ...
    if (byId('peopleDirectoryScope')) byId('peopleDirectoryScope').textContent = canManage ? 'Owner & HR access' : 'Your record only';
