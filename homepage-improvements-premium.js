(() => {
  ...
  if (window.__rolexaHomepageImprovementsPremium) return;
  window.__rolexaHomepageImprovementsPremium = true;
  ...
  style.id = 'rxHomepageImprovementsPremiumStyles';
  style.textContent = `
    #improvements.rx-improvements-premium{position:relative;padding:64px 0 68px;background:linear-gradient(180deg,#F5F7FC 0%,#EEF3FF 100%);overflow:hidden}
    ...
    #improvements.rx-improvements-premium .sec-head{position:relative;margin-bottom:32px;align-items:flex-end}
    ...
    #improvements.rx-improvements-premium .improve-card{position:relative;overflow:hidden;border:1px solid rgba(7,16,37,.08);border-radius:24px;padding:26px 26px 25px;background:rgba(255,255,255,.94);box-shadow:0 20px 50px rgba(7,16,37,.07);gap:0;transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}
    ...
    @media(max-width:900px){
      #improvements.rx-improvements-premium .improve-grid{grid-template-columns:1fr}
      #improvements.rx-improvements-premium .improve-card>p{min-height:0}
    }
    @media(max-width:760px){
      #improvements.rx-improvements-premium{padding:44px 0 48px}
      #improvements.rx-improvements-premium .wrap{padding-left:18px!important;padding-right:18px!important}
      #improvements.rx-improvements-premium .sec-head{margin-bottom:24px}
    ...
    @media(max-width:420px){
      #improvements.rx-improvements-premium .wrap{padding-left:14px!important;padding-right:14px!important}
      #improvements.rx-improvements-premium .sec-head h2{font-size:27px}
      #improvements.rx-improvements-premium .improve-card{padding:20px 17px}
      #improvements.rx-improvements-premium .improve-list li{font-size:13px}
    }
  `;
