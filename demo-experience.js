(() => {
  ...
  const employerNavLink = document.querySelector('.nav-links a[href="#employers"]');
  if (employerNavLink) employerNavLink.href = '#employer-access';
