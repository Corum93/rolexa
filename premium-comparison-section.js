(() => {
  ...
  style.textContent = `
    ...
    #why .compare-table{min-width:720px!important}
    ...
    #why .compare-table td.col-rolexa{position:relative;background:#f1f5ff!important;color:#2442b4!important;font-weight:750!important}
    #why .compare-table td.col-rolexa:before{content:'✓';display:inline-grid;place-items:center;width:21px;height:21px;border-radius:50%;background:#dfe8ff;color:#176bff;font-size:12px;font-weight:900;margin-right:10px;vertical-align:middle}
    ...
    @media(max-width:780px){
      ...
      #why .compare-table td{border:0!important;padding:0!important}
