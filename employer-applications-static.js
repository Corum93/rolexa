(() => {
  ...
  async function loadApplications(){
    ...
    const appsRes = await client.from('candidate_applications').select('user_id,job_id,status,applied_at,updated_at').in('job_id', jobIds).order('applied_at', { ascending:false });
