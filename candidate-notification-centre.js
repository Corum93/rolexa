(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .rx-notification-bell{position:relative;width:42px;height:42px;border-radius:13px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.08);color:#fff;display:grid;place-items:center;font-size:19px;font-weight:900}
      .rx-notification-bell:hover{background:rgba(255,255,255,.14)}
  ...
  function ensureUI() {
    ...
    wrap.innerHTML = `
      <button class="rx-notification-bell" id="rxCandidateNotificationBell" type="button" aria-label="Open notifications" aria-expanded="false">♢<span class="rx-notification-badge" id="rxCandidateNotificationBadge">0</span></button>
