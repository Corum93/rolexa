(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .side .internal-dept__trigger{width:100%;min-height:55px;display:flex;align-items:center;gap:10px;padding:9px 10px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:rgba(255,255,255,.07);color:#fff;text-align:left;cursor:pointer;box-shadow:0 12px 24px rgba(0,7,25,.16);transition:.18s ease}
      .side .internal-dept__trigger:before{display:none!important;content:none!important}
      ...
      .side .internal-dept__trigger:hover,.side .internal-dept.is-open .internal-dept__trigger{border-color:rgba(124,164,255,.38);background:rgba(255,255,255,.11)}
